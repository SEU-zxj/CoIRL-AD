...
def filter_tokens_coirl(coirl_records, l2_th_1, l2_th_2, l2_th_3):
    l2_tokens = []
    col_tokens = []

    for token, rec in coirl_records.items():
...
def main():
    ...
    l2_tokens, col_tokens = filter_tokens_coirl(
        coirl_results,
    ...
    l2_set = set(l2_tokens)
    col_set = set(col_tokens)
