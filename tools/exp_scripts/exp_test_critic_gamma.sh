...
sleep 5
cd ~/projects/CoIRL-AD
./tools/nusc_my_train.sh coirl/exp/19_coirl_v2+no_uncertainty+wm_action_mean+cmd_usage_before_planning+critic_gamma_0.2 8 coirl_v2_rebuttal_exp/19_no_uncertainty+wm_action_mean+cmd_usage_before_planning+critic_gamma_0.2