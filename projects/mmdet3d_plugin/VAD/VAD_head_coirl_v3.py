...
class VADHead_CoIRL_v3(DETRHead):
    """Head of VAD model.
    Args:
    ...
    def __init__(self,
                 *args,
                 perception_mode="perception-free",
        ...
        transformer['perception_mode'] = perception_mode
        self.bev_h = bev_h
        self.bev_w = bev_w
        ...
        if self.perception_mode == 'perception-based':
            ...
            if map_class_weight is not None and (self.__class__ is VADHead_CoIRL_v3):
        ...
        super(VADHead_CoIRL_v3, self).__init__(*args, transformer=transformer, **kwargs)
        if self.perception_mode == 'perception-based':
    ...
    def forward(self,
        ...
        if only_bev:  # only use encoder to obtain BEV features, TODO: refine the workaround
            ...
            outs = {'bev_embed': bev_embed, 'bev_pos': bev_pos}

            return outs
        else:
            assert self.perception_mode == 'perception-based', 'only support perception-based method'
