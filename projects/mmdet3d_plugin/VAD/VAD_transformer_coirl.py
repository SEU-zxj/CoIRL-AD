...
class VADPerceptionTransformer_CoIRL(BaseModule):
    ...
    def __init__(self,
                 ...
                 **kwargs):
        super(VADPerceptionTransformer_CoIRL, self).__init__(**kwargs)
    ...
    def forward(self,
        ...
        if self.perception_mode == 'perception-free':
            return bev_embed
        else:
            assert self.perception_mode == 'perception-based', 'only support perception-based mode'
            bs = mlvl_feats[0].size(0)
