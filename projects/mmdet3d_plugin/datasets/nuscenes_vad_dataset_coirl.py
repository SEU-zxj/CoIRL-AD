...
class VADCustomNuScenesDataset_CoIRL(NuScenesDataset):
    ...
    def prepare_train_data(self, index):
        ...
        for my_index, i in enumerate(prev_indexs_list):
            ...
            if input_dict['frame_idx'] < frame_idx and input_dict['scene_token'] == scene_token:
                ...
                # if the data is not valid (the idx as end point, the sequence length < len_queue), we should return None, and try again
                return None
    ...
    def prepare_test_data_video(self, index):
        ...
        for my_index, i in enumerate(prev_indexs_list):
            ...
            if input_dict['frame_idx'] < frame_idx and input_dict['scene_token'] == scene_token:
                ...
                # if the data is not valid (the idx as end point, the sequence length < len_queue), we should return None, and try again
                # return None
                continue # well, its OK to only contain one data, in testset, it is better to test each frame
