...
data = dict(
    ...
    train=dict(
        ...
        ann_file=data_root + 'vad_nuscenes_infos_temporal_train_singapore.pkl',
    ...
    val=dict(type=dataset_type,
             ...
             pc_range=point_cloud_range,
             interval_2frames=True,
             ann_file=data_root + 'vad_nuscenes_infos_temporal_val_boston_seaport.pkl',
